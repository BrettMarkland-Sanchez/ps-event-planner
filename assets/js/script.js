...
//this function runs when load button is clicked
...
//display the event card when it is saved
...
//when an event is loaded, run this function
//hide all buttons and only let user start over
function loadEvent() {
